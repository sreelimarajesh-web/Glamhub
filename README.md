...
- Google authentication is enabled when its server and browser client identifier is configured; `GOOGLE_AUTH_ENABLED=false` can explicitly disable it.
